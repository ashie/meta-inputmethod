...
do_install() {
    install -d ${D}/${bindir}
    install -d ${D}/${libdir}
    install -m 755 src/tools/opencc_dict ${D}/${bindir}
    install -m 755 src/libopencc.so.1.1.2 ${D}/${libdir}
    install -m 755 src/libopencc.so.1.1 ${D}/${libdir}
    install -m 755 src/libopencc.so ${D}/${libdir}
}
